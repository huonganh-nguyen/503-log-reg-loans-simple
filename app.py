...
app.layout = html.Div(children=[
    ...
    html.Div([
        ...
        html.Div([
                html.H3("Features"),
                html.Div('Graduate Education:'),
                dcc.Input(id='Graduate_Education', value=1, type='number', min=0, max=1, step=1),
                html.Div('Is Application Self Employed?:'),
                dcc.Input(id='Is_Self_Employed', value=1, type='number', min=0, max=1, step=1),
...
@app.callback(
    ...
    [Input(component_id='Graduate_Education', component_property='value'),
    Input(component_id='Is_Self_Employed', component_property='value'),
...
def prediction_function(Graduate_Education, Is_Self_Employed, Credit_History, LoanAmount, Loan_Amount_Term, ApplicantIncome, Threshold):
    try:
        data = [[Graduate_Education, Is_Self_Employed, Credit_History, LoanAmount, Loan_Amount_Term, ApplicantIncome]]
